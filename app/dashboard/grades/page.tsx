      ...
      <div className="rounded-xl border bg-white shadow-sm overflow-hidden flex-1 flex flex-col">
        {grades === undefined ? (
          ...
          <div className="flex flex-1 flex-col items-center justify-center p-12 text-center">
            ...
            <CreateGradeDialog>
              <button className="flex items-center justify-center rounded-md bg-brand-blue px-4 py-2 text-sm font-medium text-white hover:bg-brand-royal transition-colors">
          ...
          <div className="overflow-auto border-t border-gray-100">
            <Table>
              <TableHeader className="bg-gray-50/50">
                <TableRow>
                  <TableHead className="w-[300px] font-semibold text-brand-blue">
                    Name
                  </TableHead>
                  <TableHead className="font-semibold text-brand-blue">
                    Description
                  </TableHead>
                ...
                {grades.map((grade) => (
                  ...
                  >
                    ...
                    <TableCell className="text-right">
                      <button className="text-sm font-medium text-brand-blue hover:text-brand-orange transition-colors">
                        Edit
                      </button>
                    </TableCell>
                  </TableRow>
